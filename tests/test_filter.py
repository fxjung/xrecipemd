...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            BooleanAndOperation(
                operands=[
                    ...
                    AnyFilterTerm(FuzzyFilterString("b")),
                ]
            ),
        ),
        (
            ...
            BooleanOrOperation(
                operands=[
                    AnyFilterTerm(RegexFilterString(re.compile("a"))),
                    AnyFilterTerm(FuzzyFilterString("b")),
                ]
            ),
        ),
        ...
        (~(~f("a")), AnyFilterTerm(FuzzyFilterString("a"))),
        (
            "a" & (f("b") & "c") & "d",
            BooleanAndOperation(
                operands=[
                    AnyFilterTerm(FuzzyFilterString("a")),
                    AnyFilterTerm(FuzzyFilterString("b")),
                    AnyFilterTerm(FuzzyFilterString("c")),
                    AnyFilterTerm(FuzzyFilterString("d")),
                ]
            ),
        ),
        (
            ...
            IngredientGroup(
                ...
                ingredient_groups=[
                    IngredientGroup(
                        ...
                        ingredients=[
                            Ingredient(
                                amount=Amount(factor=Decimal("2"), unit="cloves"),
                                name="Garlic",
                            ),
                        ],
                        ingredient_groups=[
